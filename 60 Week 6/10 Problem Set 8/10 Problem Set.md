...
$$\displaystyle \sum_{i=0}^{n-1} \frac{1}{2} dx\cdot\bigl(f(a+i\cdot dx)+f(a+(i+1)\cdot dx)\bigr)$$ $$\displaystyle \phantom{\int_a^b f(x)\, dx} = dx\cdot\biggl(\frac{1}{2}f(a)+\left(\sum_{i=1}^{n-1}f(a+i\cdot dx)\right)+\tfrac{1}{2}f(b)\biggr)$$
